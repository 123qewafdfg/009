	...
	function processNextDecodeImage(index) {
		...
		function continueAfterImport(dataUrl) {
            ...
            if (file.size >= 20 * 1024 * 1024) {
                ...
                imageItem.innerHTML = '<span class="decode-filename">' + file.name + ' (' + formatFileSize(file.size) + ') - 大文件，已跳过预览</span>';
                imageListBoxDecode.appendChild(imageItem);
            } else if (window.appendManagedImagePreview) {
